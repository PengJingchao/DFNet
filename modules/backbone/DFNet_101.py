...
class DFNet101(nn.Module):
    def __init__(self, model_path=None, K=1):
        super(DFNet101, self).__init__()
        self.K = K
        ...
        self.RGB_layers = nn.Sequential(nn.ModuleList([Dynamic_conv2d(3, 96, kernel_size=7, stride=2),
                                        ...
                                        nn.Sequential(nn.Conv2d(96, 256, kernel_size=5, stride=2, dilation=1),
                                                      nn.ReLU(),
                                                      LRN(),
                                                      ),
...
if __name__ == "__main__":
    model = DFNet101('/home/pjc/MyProgram/RT-MDNet/models/imagenet-vgg-m.mat')
