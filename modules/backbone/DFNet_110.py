...
class DFNet110(nn.Module):
    def __init__(self, model_path=None, K=1):
        super(DFNet110, self).__init__()
        self.K = K
        ...
        self.RGB_layers = nn.Sequential(nn.ModuleList([Dynamic_conv2d(3, 96, kernel_size=7, stride=2),
                                        ...
                                        nn.Sequential(nn.Conv2d(256, 512, kernel_size=3, stride=1, dilation=3),
                                                      nn.ReLU(),
                                                      ))
        ...
        for nameid, (name, module) in enumerate(self.layers.named_children()):
            ...
            if run:
                if name == 'conv1':
                    ...
                    featR = self.RGB_layers[nameid](featR)
                    featT = self.T_layers[nameid](featT)
...
if __name__ == "__main__":
    model = DFNet110('/home/pjc/MyProgram/RT-MDNet/models/imagenet-vgg-m.mat')
