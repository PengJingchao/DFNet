...
class MDNetRgbtFeatureLevelFusion(nn.Module):
    def __init__(self, model_path=None, K=1):
        super(MDNetRgbtFeatureLevelFusion, self).__init__()
        self.K = K
...
if __name__ == "__main__":
    model = MDNetRgbtFeatureLevelFusion('/home/pjc/MyProgram/RT-MDNet/models/imagenet-vgg-m.mat')
    print(model.RGB_layers[0][0].weight.shape)
    print(model.RGB_layers[0][0].bias.shape)
    print(model.T_layers[0][0].weight.shape)
    print(model.T_layers[0][0].bias.shape)
    print(model.RGB_layers[1][0].weight.shape)
    print(model.RGB_layers[1][0].bias.shape)
    print(model.T_layers[1][0].weight.shape)
    print(model.T_layers[1][0].bias.shape)
    print(model.RGB_layers[2][0].weight.shape)
    print(model.RGB_layers[2][0].bias.shape)
    print(model.T_layers[2][0].weight.shape)
    print(model.T_layers[2][0].bias.shape)
